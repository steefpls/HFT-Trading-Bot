...
current_ticker = "NVDA"
useYFinance = True #true = use yfinance for tracking high and close prices, false = use own tracked data for tracking high and close prices. This is only used for backtest broker
